...
public class VarysConfigurer {
    ...
    private VarysConfig varysConfig() {
        return getBeanOrAutowire(VarysConfig.class, defaultVarysConfigSupplier());
    }

    private Supplier<VarysConfig> defaultVarysConfigSupplier() {
        return () -> getConfig(VarysConfig.class);
    }
}
