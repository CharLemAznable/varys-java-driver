...
@Component
public final class VarysProxyWechatTpAuthUrlProvider implements UrlProvider {

    private final VarysConfig varysConfig;

    public VarysProxyWechatTpAuthUrlProvider() {
        this(null);
    }

    @Inject
    @Autowired
    public VarysProxyWechatTpAuthUrlProvider(@Nullable VarysConfig varysConfig) {
    ...
    public String url(Class<?> clazz) {
        ...
        return appendIfMissing(address, "/") + "proxy-wechat-tp-auth";
    }
}
